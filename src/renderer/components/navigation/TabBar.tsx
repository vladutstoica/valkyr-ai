...
export function TabBar({ openInPath, isRemote = false, sshConnectionId = null }: TabBarProps) {
  const { activeTab, setActiveTab, gitChangesCount, isAgentWorking } = useTabState();

  return (
    <div className="border-border bg-muted/30 flex h-11 items-center justify-between border-b">
