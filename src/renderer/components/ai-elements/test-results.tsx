...
export type TestResultsSummaryDisplayProps = HTMLAttributes<HTMLDivElement>;

export const TestResultsSummaryDisplay = ({
  className,
  children,
  ...props
}: TestResultsSummaryDisplayProps) => {
...
export type TestStatusDisplayProps = HTMLAttributes<HTMLSpanElement>;

export const TestStatusDisplay = ({ className, children, ...props }: TestStatusDisplayProps) => {
