...
export const Tool = ({ className, ...props }: ToolProps) => (
  <Collapsible
    className={cn("group/tool not-prose mb-0.5 w-full", className)}
    {...props}
  />
);
...
export const ToolHeader = ({
  ...
  return (
    <CollapsibleTrigger
      className={cn(
        "flex w-full items-center gap-1.5 rounded px-1.5 py-1 text-xs text-muted-foreground hover:bg-muted/50 transition-colors",
...
export const ToolInline = ({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-1.5 px-1.5 py-0.5 text-xs text-muted-foreground",
        isError && "text-red-500",
        className,
      )}
    >
  ...
  return (
    <div className={cn("mb-0.5", className)}>
      <button
        ...
        className="flex items-center gap-1.5 px-1.5 py-0.5 text-xs text-muted-foreground hover:text-foreground transition-colors"
      >
        <ChevronRightIcon
          className={cn(
      ...
      {expanded && <div className="ml-3 border-l border-border/40 pl-1">{children}</div>}
    </div>
  );
};
