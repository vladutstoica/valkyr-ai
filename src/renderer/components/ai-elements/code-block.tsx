...
const TokenSpan = ({ token }: { token: ThemedToken }) => (
  <span
    className="dark-black:!bg-[var(--shiki-dark-bg)] dark-black:!text-[var(--shiki-dark)] dark:!bg-[var(--shiki-dark-bg)] dark:!text-[var(--shiki-dark)]"
    style={
      {
...
const CodeBlockBody = memo(
  ({
    ...
    return (
      <pre
        className={cn(
          'dark-black:!bg-[var(--shiki-dark-bg)] dark-black:!text-[var(--shiki-dark)] m-0 p-4 text-sm dark:!bg-[var(--shiki-dark-bg)] dark:!text-[var(--shiki-dark)]',
          className
        )}
        style={preStyle}
      >
