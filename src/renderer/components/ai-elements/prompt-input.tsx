...
export const PromptInputActionAddAttachments = ({
  ...
  return (
    <DropdownMenuItem
      {...props}
      onClick={() => {
        // Use onClick (not onSelect) to keep the user-gesture chain intact.
        // Radix onSelect fires asynchronously after menu close animation,
        // which breaks programmatic file input .click() in Electron.
...
export type PromptInputActionMenuTriggerProps = Omit<ComponentProps<typeof Button>, 'variant'> & {
...
export const PromptInputActionMenuTrigger = ({
  ...
  <DropdownMenuTrigger asChild>
    <Button
      className={cn('size-8 p-0 shadow-none has-[>svg]:p-0', className)}
      type="button"
      variant="ghost"
      {...props}
    >
...
export const PromptInputActionMenuContent = ({
  ...
  <DropdownMenuContent align="start" side="top" className={cn(className)} {...props} />
);
